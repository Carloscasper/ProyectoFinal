    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="bg-gray-800 ">
            ...
            <div>
                <ul>
                    ...
                    <li class="mr-3 flex-1">
                        <a href="{{route('pediatra')}}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                        ...
                        <a href="oftarmologo" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
        ...
        <div>
            <div class="imagenAncho">
                <img src="/images/oftarmología.jpg " width="1200" height="800">
                    
                
                    <div class="centrado">
                        <p style=" color:white; font-size:25px;" >Departamento Oftarmología
                        <br>Calle Calzada del Ejército 171, Oblatos, 44340 
                        <br>Guadalajara, Jalisco
                        <br>3333450075
                        <br>
                        <br>Un oftalmólogo es un doctor, médico u osteópata, especializado en el cuidado
                        <br>de los ojos y la visión. Los oftalmólogos tienen de 12 a 13 años estudios de
                        <br>medicina y especialización y tienen licencia para ejercer su profesión de
                        <br>médicos y cirujanos. Esta capacitación avanzada permite a los oftalmólogos
                        <br>diagnosticar y tratar un mayor rango de afecciones que los optómetras y los
                        <br>ópticos. Su capacitación típica incluye cuatro años de universidad seguidos de
                        <br>al menos ocho años de capacitación médica adicional.
