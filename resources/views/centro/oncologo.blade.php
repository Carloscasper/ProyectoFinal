    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div>
            <div class="imagenAncho">
                <img src="/images/oncología.jpg " width="1200" height="800">
                    
                
                    <div class="centrado">
                        <p style=" color:white; font-size:25px;" >Departamento de Oncología y Radioterapia
                        <br>Av.  Belisario Domínguez 1000, Oblatos, 44340 
                        <br>Guadalajara, Jalisco
                        <br>36170060
                        <br>
                        <br>La oncología es el estudio del cáncer. Un oncólogo es el médico que trata el cáncer 
                        <br>y proporciona atención médica para una persona diagnosticada con cáncer.
                        <br>El campo de la oncología tiene tres áreas principales: 
                        <br>clínica, cirugía y radiación.
                           
                        
                        </p>
                        <ul class="a" style="color: white; font-size:25px">
                            <li>
                                Un oncólogo clínico trata el cáncer con quimioterapia u otros medicamentos, 
                                <br>como la terapia dirigida o la inmunoterapia.
                            </li>
                            <li>
                                Un cirujano oncólogo quita el tumor y el tejido cercano 
                                <br>durante la cirugía. Además, realiza ciertos tipos de biopsias para ayudar a diagnosticar el cáncer
                            </li>
                            <li>
