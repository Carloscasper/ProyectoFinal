    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div>
            <div class="imagenAncho">
                <img src="/images/pedriatría.jpg " width="1200" height="800">
                    
                
                    <div class="centrado">
                        <p style=" color:white; font-size:25px;" >Departamento de Pediatría
                        <br>Calle Dionisio Rodriguez 518, San juan de Dios, 44360 
                        <br>Guadalajara, Jalisco
                        <br>361703311
                        <br>
                        <br>Médico que tiene una formación especial para prevenir, diagnosticar y tratar
                        <br>enfermedades y lesiones en los niños. Los pediatras también ayudan 
                        <br>a tratar otros problemas que afectan a los niños; por ejemplo, trastornos del desarrollo, y problemas
                        <br>de comportamiento, emocionales y sociales.
