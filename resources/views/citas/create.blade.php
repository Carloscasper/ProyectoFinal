                    ...
                    <img src="/images/appo.jpg " width="1200" height="800">
                        ...
                        <div class="centrado">
                            ...
                            <form action="{{route('citas.store')}}" method="POST">
                                ...
                                <label style="font-size: 40px;">Centros:</label>
                                <select style="font-size: 40px;"  name="centro_id">
                                ...
                                <label style="font-size: 40px;" for="fecha">Fecha:</label><br>
                                <input style="font-size: 40px;" type="datetime-local" id="fecha" name="fecha">
                                
                            
                                <br><br>
                                
                        
                                <button  style="font-size: 40px;" type="submit" onclick="creadaConExito()" >enviar</button>
                            </form>
