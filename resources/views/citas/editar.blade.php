                ...
                <div class="centrado"> 
                    <div>
                        ...
                        <form action="{{route('citas.update', $cita)}}" method="POST">
                            ...
                            <label style="font-size: 40px; color:white">Centros:</label>
                            <select name="centro_id"  style="font-size: 40px; color:white">
                            ...
                            <label for="fecha" style="font-size: 40px; color:white">Fecha:</label>
                            <input type="datetime-local" id="fecha" name="fecha" style="font-size: 40px; color:white">
                            
                        
                            <br><br>
                            
                    
                            <button type="submit" style="font-size: 40px; color:white">Enviar</button>
                        </form>
