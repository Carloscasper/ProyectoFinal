                ...
                <ul>
                    ...
                    <li class="mr-3 flex-1">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eyeglass-2" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Centros</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div>
            ...
            <div>
                <div class="imagenAncho">
                    <img src="/images/appo.jpg " width="1200" height="800">
                        ...
                        <div class="centrado">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                    <label style="font-size: 40px;" for="email" value="{{ __('Email') }}">Email</label>
                                    <input style="font-size: 40px;" type="email" name="email" required minlength="16" maxlength="255" size="20" :value="old('email')" required autofocus>
                                    <br>
                                    <br>
                                    <label style="font-size: 40px;" for="password" value="{{ __('Password') }}">Contraseña</label>
                                    <input style="font-size: 40px; " type="password" name="password" required minlength="4" maxlength="255" size="20" required autocomplete="current-password">
                                    <br>


                                <button  style="font-size: 40px;" type="submit">enviar</button>
                            </form>
